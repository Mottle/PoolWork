...
class SpanTreeGNNWithOrt(nn.Module):
    ...
    def compute_ort_loss(self, f1, f2):
        cosine_scores = F.cosine_similarity(f1, f2, dim=1).abs()
        total_similarity_score = torch.sum(cosine_scores)
    ...
    def forward(self, x, edge_index, batch):
        ...
        for i in range(self.num_layers):
            ...
            ort_loss += self.compute_ort_loss(graph_feature, mst_feature)
